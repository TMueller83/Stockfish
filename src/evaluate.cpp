...
namespace {
  ...
  constexpr int KingAttackWeights[PIECE_TYPE_NB] = { 0, 0, 77, 50, 42, 10 };

  // Penalties for enemy's safe checks
  constexpr int QueenSafeCheck  = 761;
  constexpr int RookSafeCheck   = 1038;
  constexpr int BishopSafeCheck = 602;
  constexpr int KnightSafeCheck = 751;
